package com.example.cleansafi1;
...
import com.example.cleansafi1.account.LoginActivity;
import com.example.cleansafi1.utils.AppGlobals;
import com.example.cleansafi1.utils.Helpers;
import com.example.cleansafi1.utils.TimeDialog;
...
import static com.example.cleansafi1.CheckOutActivity.sAddressId;
...
public class CheckoutStageTwo extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectLocation =  findViewById(R.id.spinner);
        deliveryTimeLayout =  findViewById(R.id.layout_drop);
        selectDropTime =  findViewById(R.id.drop_time_text);
        pickUpTimeText =  findViewById(R.id.pick_up_time_text);
        switchCompat =  findViewById(R.id.express_service);
        totalPrice =  findViewById(R.id.total_price);
        sendRequest =  findViewById(R.id.send_request);
        pickUpLayout =  findViewById(R.id.layout_pick_up);
        dropTime =  findViewById(R.id.drop_time);
